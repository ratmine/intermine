...
my $sub_item = $item_doc->add_item('Submission', title => 'eQTL Data', experimentDate => '20100301', publication => $pub_item);
												
my $project_item = $item_doc->add_item('Project', name =>'eQTL Data',	namePI => 'Timothy',	surnamePI => 'Aitman',	submissions => [$sub_item]);
